...
plot(snpnet,edge.color="black",edge.label=round(E(snpnet)$homoplasy_percent,2),edge.label.cex=2)
#INDEL net homoplasies
...
plot(indelnet,edge.color="black",edge.label=round(E(indelnet)$homoplasy_percent,2),edge.label.cex=2)
```
