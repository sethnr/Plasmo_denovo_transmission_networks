...
```{r}
#HFGR - GII
tempH2 <- read.table("../../analyses/haplotypePlots_HFGR/HFGR_all.incDD2.PASS.HFGR.LMRG.RENAME.HF2.temporal.txt")
...
```{r}
#HFGR - GIII
tempH3 <- read.table("../../analyses/haplotypePlots_HFGR/HFGR_all.incDD2.PASS.HFGR.LMRG.RENAME.HF3.temporal.txt")
