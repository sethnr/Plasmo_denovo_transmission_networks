...
njtree1 <- drop.tip(njtree1,c(cl1,cl3))
#plot(njtree1)
...
parsTree <- drop.tip(parsTree,c(cl1,cl3))
#plot(parsTree)
```
...
njtree1 <- drop.tip(njtreeGATK,c(cl1,cl3))
#plot(njtreeGATK)
...
parstreeGATK <- drop.tip(parstreeGATK,c(cl1,cl3))
#plot(parstreeGATK)
```
...
```r
njSupp <- getSplitSupports(njtree1,genos[cl2,])
parsSupp <- getSplitSupports(parsTree,genos[cl2,])
...
```r
parsSupp <- getSplitSupports(parsTree,genos[cl2,])
parsSuppIn <- getSplitSupports(parsTree,genos[cl2,discInHap])
parsSuppOut <- getSplitSupports(parsTree,genos[cl2,!discInHap])
parsSuppIn$inHap=T
parsSuppOut$inHap=F
...
```r
parsSuppGATK <- getSplitSupports(parstreeGATK,genosGATK[cl2,])

parsSuppGATKin <- getSplitSupports(parstreeGATK,genosGATK[cl2,hapInDisc])
parsSuppGATKout <- getSplitSupports(parstreeGATK,genosGATK[cl2,!hapInDisc])
