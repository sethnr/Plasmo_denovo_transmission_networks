...
netGATK <- makeNetSingle(as.dist(sym(gatkDistsCore[cl1,cl1])),meta)
printGraph(netGATK[],"Greens",title = "HaplotypeCaller - core genome")

```
```{r}

bootstrapNets <- function(genosStatic,outfolder) {
  genosStatic <- genos
