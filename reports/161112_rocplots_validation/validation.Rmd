...
callbothGATK <- read.table("thies_300100_haplo.CALLBOTH.dist.tab.txt",sep="\t")
callbothGATK$from=rownames(callbothGATK)
callbothGATK <- melt(callbothGATK,variable.name = "to",value.name="both")
callhaploGATK <- read.table("thies_300100_haplo.CALLHAPLO.dist.tab.txt",sep="\t")
callhaploGATK$from=rownames(callhaploGATK)
callhaploGATK <- melt(callhaploGATK,variable.name = "to",value.name="both")
...
callCf <- merge(merge(callboth,callDisco),merge(callbothGATK,callhaploGATK))
callCf <- merge(callCf,merge(callsnp,callindel))
