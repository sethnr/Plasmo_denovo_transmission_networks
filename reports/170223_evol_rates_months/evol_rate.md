...
```r
corer1 <- getEvolRates(varNets[[1]],coreDists) 
inaccr1 <- getEvolRates(varNets[[1]],(indDists+snpDists)-coreDists) 
...
## 13	P.falciparum	P.falciparum (snp)	Eukaryote	18446000	1.2e-06	22.615	among	8	ours	SNP	all	2.3 wks
## 14	P.falciparum	P.falciparum (ind)	Eukaryote	18446000	4.2e-07	7.83	among	8	ours	INDEL	all	1.5 mths
## 15	P.falciparum	P.falciparum (all)	Eukaryote	18446000	1.7e-06	30.448	among	8	ours	SNP+INDEL	all	1.7 wks
## 16	P.falciparum	P.falciparum (core)	Eukaryote	15180000	5.4e-07	8.17	among	8	ours	SNP+INDEL	accessible	1.5 mths
## 17	P.falciparum	P.falciparum (inacc)	Eukaryote	3266000	6.8e-06	22.273	among	8	ours	SNP+INDEL	inaccessible	2.3 wks
```
