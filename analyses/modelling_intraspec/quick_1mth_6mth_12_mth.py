...
outfile = open("qstages.C"+str(args.C/1e6)+"m.L"+str(args.L/1e6)+"mb.G"+str(args.G)+F+".txt","w")
afreqs = open("qstages.C"+str(args.C/1e6)+"m.L"+str(args.L/1e6)+"mb.G"+str(args.G)+F+".AFs.txt","w")
...
pop.evolve(14) #+28 days -> 28 days
allele_frequencies.append(pop.get_allele_frequencies()) 
tp.append(pop.generation)
_printGen()

pop.evolve(76) #+152 days -> 180 days (6mth)
allele_frequencies.append(pop.get_allele_frequencies()) 
tp.append(pop.generation)
_printGen()

pop.evolve(90) #+180 days -> 360 days (12mth)
allele_frequencies.append(pop.get_allele_frequencies()) 
tp.append(pop.generation)
_printGen()
