...
TREEFOLDER=/seq/plasmodium/sredmond/pfdisco/analyses/njtree_thies/discord_bootstraps/
TREEPARENT=/seq/plasmodium/sredmond/pfdisco/analyses/njtree_thies/
...
#	-t ${TREEFOLDER}/Thies_manual.nj.NJ.nexus \
	...
	-t ${TREEPARENT}/Thies_all_manual.PASS.Cls.miss0.5.LMRG.HAP.vcf.NJ.nexus \
	${TREEFOLDER}/boot_${SET}/Thies*nexus
